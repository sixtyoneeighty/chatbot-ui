...
AS $$
DECLARE
  project_url TEXT := 'https://tiehyfsjnsdscadrppor.supabase.co"
;
  service_role_key TEXT := "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRpZWh5ZnNqbnNkc2NhZHJwcG9yIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzkwNDkyNzksImV4cCI6MjA1NDYyNTI3OX0.IzWixY7UJfbKI9AD9kHLHiGZd80qqO1zuylyZK4dGSs"
