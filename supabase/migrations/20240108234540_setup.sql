...
AS $$
DECLARE
  project_url TEXT := 'hhttps://wggyntdcwlxuhaynsmth.supabase.co';
  service_role_key TEXT :="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndnZ3ludGRjd2x4dWhheW5zbXRoIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczMzMwNzI3MywiZXhwIjoyMDQ4ODgzMjczfQ.8B1ztxs8IMKpbva6Lr_kkz0QaAQkR_pkw5yiSruzvWs"
BEGIN
  SELECT
      INTO status, content
