...
AS $$
DECLARE
  project_url TEXT := 'https://pynbzygbcdvzzokprgck.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InB5bmJ6eWdiY2R2enpva3ByZ2NrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTU3NDMxNDcsImV4cCI6MjAzMTMxOTE0N30.X-c5wOm5Zro93EH96DUtcd9ZdMf63CPoj_Eh2rHjVeg'; -- full access needed for http request to storage
